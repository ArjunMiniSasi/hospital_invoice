...
Container medicineTile(MedicineModel medicineModel, BuildContext context) {
  return Container(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Text("Rs " + medicineModel.unitCost.toString(),
                            ...
                            const Text("Quantity: "),
                            Text(medicineModel.requiredQuantity.toString(),
                                style: const TextStyle(
                                  fontWeight: FontWeight.bold,
                                )),
                          ],
